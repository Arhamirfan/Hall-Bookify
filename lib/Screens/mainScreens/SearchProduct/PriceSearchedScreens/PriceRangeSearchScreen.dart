...
import 'package:hall_bookify/Screens/mainScreens/SearchProduct/Searches/ViewPackageByMultiplePrice.dart';

import '../../../../Widgets/input_widget.dart';
import '../../../../Widgets/textFieldInput.dart';
import '../Searches/ViewPackageByPrice.dart';

class PriceRangeSearchScreen extends StatefulWidget {
  @override
  _PriceRangeScreenState createState() => _PriceRangeScreenState();
}

class _PriceRangeScreenState extends State<PriceRangeSearchScreen> {
                          ...
                          Padding(
                            ...
                            child: RaisedButton(
                              onPressed: () {
                                ...
                                Navigator.push(context, MaterialPageRoute(
                                  builder: (context) {
                                    return ViewPackageByMultiplePrice(

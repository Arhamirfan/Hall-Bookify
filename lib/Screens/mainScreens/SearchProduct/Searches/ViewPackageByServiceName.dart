...
class ViewPackageByServiceName extends StatelessWidget {
  String PackageName;
  int length = 0;
  ViewPackageByServiceName({required this.PackageName});
            ...
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('services', isGreaterThanOrEqualTo: PackageName)
                    .where('services',
